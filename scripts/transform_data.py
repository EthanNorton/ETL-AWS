...
def transform_data(): #again, this could come from dotenv file to avoid hardcoding
    ...
    # I begin the next step with merging if applicable, and then go by checking if there is missing files or values 
